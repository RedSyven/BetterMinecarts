...
execute unless entity @s[type=minecraft:furnace_minecart] store result storage betterminecarts:data x_motion double 1.0 run data get entity @s Motion[0]
execute unless entity @s[type=minecraft:furnace_minecart] store result storage betterminecarts:data y_motion double 1.0 run data get entity @s Motion[1]
execute unless entity @s[type=minecraft:furnace_minecart] store result storage betterminecarts:data z_motion double 1.0 run data get entity @s Motion[2]
